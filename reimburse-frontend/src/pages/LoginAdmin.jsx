  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/login`, {
        username,
        password,
        role: "admin", // Kirim role admin ke backend
      });
      ...
      if (!user.is_admin) {
        setErrorMsg("Akun ini bukan admin. Gunakan halaman login user.");
        return;
      }
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="md:w-1/2 w-full flex flex-col justify-center items-center pl-18 text-white"
      >
        <motion.img
          src="/klaim.png"
          alt="Klaimee Logo"
